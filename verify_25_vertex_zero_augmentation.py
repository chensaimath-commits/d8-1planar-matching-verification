#!/usr/bin/env python3
"""Verify the 25-vertex zero-augmentation exclusion, (R,k,a)=(12,3,0)."""
...
def verify_quartic_branch() -> None:
    subprocess.run(
...
def main() -> None:
    verify_quartic_branch()
    verify_common_core()
    print("PASS case 3: 25-vertex zero-augmentation exclusion")
